...
var onRequestPost = /* @__PURE__ */ __name(async (context) => {
  ...
  try {
    ...
    const type = body.type || "room";
    const checkOut = body.checkOut || null;
    const guests = body.guests || null;
    const roomType = body.roomType || body.hallType || null;
    ...
    const result = await env.DB.prepare(
      `INSERT INTO bookings (name, email, phone, type, check_in, check_out, guests, room_type)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?)`
    ).bind(name, email, phone, type, checkIn, checkOut, guests, roomType).run();
    return Response.json({
      success: true,
...
// ../.wrangler/tmp/pages-igwQQC/functionsRoutes-0.6159250321468571.mjs
var routes = [
  {
    routePath: "/api/book",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-t18x3B/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-t18x3B/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.05899048448708333.mjs.map
